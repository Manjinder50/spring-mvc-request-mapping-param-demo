...
public class RequestMappingAndParamDemoController {
	...
	//test 6 subtest2: Testing removal of @RequestMapping ambiguity with the same base URI but
	//with a different parameter
	...
	//test 6 subtest3: Testing removal of @RequestMapping with multiple request params
	...
	public String requestMappingAndParamTest6Subtest3(@RequestParam String orgname,@RequestParam String empcount,Model model){
		...
		model.addAttribute("testserial","test6-subtes3");
		return "requestMappingAndParamResults2";
	}
	//test 6 subtest4: Testing removal of @RequestMapping with multiple request params
	...
	//test 7 & 8:Testing @RequestParam with single param.
